...
if ($args.count -gt 0 -And $args[0] -in ("store-camera-1.jpg", "store-camera-2.jpg", "store-camera-3.jpg", "store-camera-4.jpg","pasar1.jpg","pasar2.jpg"))
{
    $img_file = $args[0]
}

$img = "https://raw.githubusercontent.com/Ragowo/SourceCodeAI/main/data/vision/$img_file"
